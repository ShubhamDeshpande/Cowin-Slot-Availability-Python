...
try:
    ...
    while True:
        ...
        uri = "https://cdn-api.co-vin.in/api/v2/appointment/sessions/public/findByDistrict?district_id={districtId}&date={date}".format(
        ...
        if (dataCount == 0):
            ...
            if len(email) > 0:
                ...
                message = 'Subject: {SUBJECT}\n\n{TEXT}'.format(SUBJECT='Cowin Center found',
                                                                TEXT=json.dumps(webData["sessions"], indent=3))
        ...
        print(
            "LastRefresh: {currentTime}, Age Group: {minAgeLimit} Years, Next Refresh In: {waitSeconds} Seconds".format(
